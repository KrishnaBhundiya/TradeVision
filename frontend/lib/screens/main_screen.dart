...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: isDark ? DarkSurface.bg : theme.scaffoldBackgroundColor,
      body: LayoutBuilder(
      ...
      bottomNavigationBar: MediaQuery.of(context).size.width > 900
          ? null
          : Container(
              height: AppDim.tabBarHeight + MediaQuery.of(context).padding.bottom,
              decoration: BoxDecoration(
                color: navBg,
                border: Border(
                  top: BorderSide(
              ...
              child: SafeArea(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _buildNavItem(1, Icons.candlestick_chart_outlined, Icons.candlestick_chart, 'Market'),
  ...
  Widget _buildNavItem(int index, IconData outlinedIcon, IconData filledIcon, String label) {
    ...
    final unselectedColor = DarkSurface.textMuted;
